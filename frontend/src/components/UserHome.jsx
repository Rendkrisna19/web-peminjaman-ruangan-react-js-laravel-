...
export default function UserHome() {
    ...
    return (
        <UserLayout>
            {/* --- HERO SECTION --- */}
            {/* Menggunakan Gray-900 (Hitam) dan sudut tajam */}
            <div className="relative bg-gray-900 text-white mb-16 overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10 px-8 py-20 md:py-28 max-w-5xl mx-auto text-center">
                    ...
                    <p className="text-gray-400 text-lg md:text-xl mb-10 max-w-2xl mx-auto font-light leading-relaxed">
                        Akses jadwal real-time lab, ruang kelas, dan aula. Ajukan peminjaman secara digital, pantau status persetujuan langsung dari dashboard.
                    </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 max-w-6xl mx-auto">
                ...
                <div className="bg-gray-100 p-10 border-l-4 border-gray-900">
                    ...
                    <button className="px-6 py-3 bg-white border border-gray-300 text-gray-900 text-sm font-bold uppercase hover:bg-gray-900 hover:text-white transition-all">
                        Hubungi Admin
                    </button>
                </div>
                ...
                <div className="bg-gray-900 text-white p-10 flex flex-col justify-between">
                    <div>
                        <h3 className="text-xl font-bold uppercase tracking-wide mb-2">Dokumen SOP</h3>
                        <p className="text-gray-400 text-sm">Download aturan penggunaan fasilitas lab & kelas.</p>
                    </div>
                    <div className="mt-6 flex justify-end">
                        <button className="w-12 h-12 flex items-center justify-center bg-white text-gray-900 hover:bg-gray-200 transition">
                            <ArrowRight size={20} />
                        </button>
                    </div>
                </div>
