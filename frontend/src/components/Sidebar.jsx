...
import { LayoutDashboard, Building2, CalendarClock, FileText, CheckSquare, LogOut } from 'lucide-react';
...
export default function Sidebar() {
    ...
    return (
        <div className="bg-primary text-white w-64 min-h-screen flex flex-col shadow-xl fixed left-0 top-0 z-50 transition-all duration-300">
            {/* Logo Area */}
            ...
            <div className="p-6 pb-2">
                ...
                <span className={`text-[10px] px-2 py-0.5 rounded-full mt-1 inline-block ${isAdmin ? 'bg-red-500/20 text-red-300' : 'bg-green-500/20 text-green-300'}`}>
